...
class TagGame:
    ...
    def add_player(self, discord_id: int, discord_name: str, lan_id: Optional[str] = None) -> bool:
    ...
    def resolve_dodge_challenge(self, target_id: int, challenge_id: str, success: bool) -> Dict:
    ...
    def cleanup_expired_challenges(self):
        ...
        for target_id in expired_challenges:
            ...
            self.resolve_dodge_challenge(target_id, self.active_challenges[target_id]["challenge_id"], False)
