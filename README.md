...
- **Dodge Challenges**: AI-powered trivia challenges to dodge tags
...
- OpenAI API Key (for AI trivia challenges)
...
3. **Configure the bot**:
   ...
   - Replace `YOUR_OPENAI_API_KEY_HERE` with your OpenAI API key (optional, for AI trivia challenges)
...
When tagged, players must complete an AI-powered trivia challenge:

**AI Trivia Challenge**: Answer a challenging trivia question generated by ChatGPT
- Example: "What year did the Berlin Wall fall?" → Answer: "1989"
- Requires OpenAI API key to be configured
- Falls back to challenging trivia questions if AI is unavailable
- Questions cover history, science, geography, literature, and obscure facts
