...
4. **AI Trivia Challenge**: Answer a trivia question generated by ChatGPT
   - Example: "What is the capital of Japan?" → Answer: "Tokyo"
   - Requires OpenAI API key to be configured
   - Falls back to simple trivia if AI is unavailable
